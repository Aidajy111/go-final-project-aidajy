...
Это веб-приложение-планировщик задач на Go с использованием SQLite базы данных.  
...
Примечание: Здравствуйте. Не понимаю почему тесты падают, все вроде работает в вебе и отдельно тесты тоже Ок, но почему-то не проходят, нужно ли менять тесты?
